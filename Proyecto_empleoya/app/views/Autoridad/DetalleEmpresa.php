    ...
    <section class='login-wrapper py-5 home-wrapper-2'>
        <div class="container-xxl">
            <div class='d-flex justify-content-start p-5 pt-0 pb-0'>
                <h1>Estadisticas Empresa: name</h1>
            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card text-center">
                                        <div class="card-body">
                                            <h4 class="card-title">Nombre</h5>
                                            <p class="card-text">Ciudad: XX</p>
                                            <p class="card-text">Sitio Web: XX</p>
                                            <p class="card-text">Correro Electronico: XX</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [
                    {
                        label: 'Cantidad de Ofertas Publicadas',
                        data: postulaciones,
