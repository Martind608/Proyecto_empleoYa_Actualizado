            ...
            <div class="p-5 pt-2">
                ...
                <div class="">
                    ...
                    <div class="row">
                        ...
                        <div class="col d-flex align-items-center border border-dark"><?= $postulante['IDUsuario'] ?>
                        </div>
                        <div class="col d-flex align-items-center border border-dark"><?= $postulante['Nombre'] ?></div>
                        <div class="col d-flex align-items-center border border-dark"><?= $postulante['Apellido'] ?>
                        </div>
