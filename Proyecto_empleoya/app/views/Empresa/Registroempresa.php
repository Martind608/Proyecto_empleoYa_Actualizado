...
<body>
    <header>
        <nav class="navbar navbar-expand-lg  p-0 pt-0">
            ...
            <div class='col-12'>
                <div class='auth-card'>
                    ...
                    <form action="../../controllers/RegistroEmpresaControlador.php" method="post"
                        ...
                        <input class='form-control' type='text' name='RazonSocial' placeholder='Razon Social' required />
                        <input class='form-control' type='number' name='CUIT' placeholder='CUIT' required />
                        ...
                        <input class='form-control' type='text' name='SitioWeb' placeholder='Sitio Web' required />
                            ...
                            <div class="modal fade" id="Registroincorrecto" tabindex="-1"
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content ">
                                        ...
                                        <div class="modal-body d-flex justify-content-center">
                                            <p>Error en el registro de la Empresa. El correo electrónico ya existe.</p>
                                        </div>
